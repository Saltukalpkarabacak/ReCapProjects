...
namespace Business.Concrete
{
    ...
    {
        private IUserRService _userService;
        private ITokenHelper _tokenHelper;

        public AuthManager(IUserRService userService, ITokenHelper tokenHelper)
        {
        ...
        public IResult UserExists(string email)
        {
            ...
            {
                return new ErrorReslut(Messages.UserAlreadyExists);
            }
